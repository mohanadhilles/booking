...
class EventmieServiceProvider extends ServiceProvider
{
    ...
    */
    ...
    private function loadMiddlewares()
    {
        ...
        $this->app['router']->aliasMiddleware('verified', \Classiebit\Eventmie\Middleware\EnsureEmailIsVerified::class);
    ...
    {
        $theme_url = url('').'/eventmie-assets?path='.urlencode('css/voyager.css');
