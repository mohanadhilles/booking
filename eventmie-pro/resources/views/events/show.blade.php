                        ...
                        <div class="lgx-about-service">
                             <div class="lgx-single-service lgx-single-service-color">
                                 <div class="text-area">
                                    ...
                                    @if(!$event->repetitive)
                                    <p>
                                        {{ \Carbon\Carbon::createFromFormat('Y-m-d', $event->start_date)->translatedFormat('d M Y') }}, 
                                        {{ \Carbon\Carbon::createFromFormat('Y-m-d', $event->start_date)->translatedFormat('l') }}, 
                                        {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $event->start_date.''.$event->start_time)->translatedFormat('h:i A') }}

                                        <br>@lang('eventmie-pro::em.till')<br>

                                        {{ \Carbon\Carbon::createFromFormat('Y-m-d', $event->end_date)->translatedFormat('d M Y') }}, 
                                        {{ \Carbon\Carbon::createFromFormat('Y-m-d', $event->end_date)->translatedFormat('l') }}, 
                                        {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $event->end_date.''.$event->end_time)->translatedFormat('h:i A') }}
                                    </p>
                                    @else
                                    <p>
                                        {{ \Carbon\Carbon::createFromFormat('Y-m-d', $event->start_date)->translatedFormat('d M Y') }}
