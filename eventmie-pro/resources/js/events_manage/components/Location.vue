                ...
                <div class="panel-heading">
                    ...
                    <form ref="form" @submit.prevent="validateForm" method="POST" enctype="multipart/form-data" class="lgx-contactform">
                        ...
                        <div class="form-group">
                            <input type="checkbox" class="custom-control-input" name="online_event" v-model="online_event" :value="1">
                        ...
                        <div class="form-group">
                            ...
                            <span v-show="errors.has('venue') && online_event <= 0" class="help text-danger">{{ errors.first('venue') }}</span>
                        </div>    

                        <div class="form-group">
                            <label for="latitude">Google {{ trans('em.map_lat') }}</label>
                            <input type="text" class="form-control" name="latitude" placeholder="e.g 27.1751448" v-model="latitude">
                        </div>    

                        <div class="form-group">
                            <label for="longitude">Google {{ trans('em.map_long') }}</label>
                            <input type="text" class="form-control" name="longitude" v-model="longitude" placeholder="78.0399535">
                            
                        </div>    

                        <div class="form-group">
                            <label for="address">{{ trans('em.venue_address') }}</label>
                            <textarea class="form-control" rows="3" name="address" v-model="address"></textarea>
                            <span v-show="errors.has('address') && online_event <= 0" class="help text-danger">{{ errors.first('address') }}</span>
                        </div>
                            
                        <div class="form-group">
                            <label for="city">{{ trans('em.city') }}</label>
                            <input type="text" class="form-control"  name="city" v-model="city">
                            <span v-show="errors.has('city') && online_event <= 0" class="help text-danger">{{ errors.first('city') }}</span>
                        </div>     
                        
                        <div class="form-group">
                            <label for="state">{{ trans('em.state') }}</label>
                            <input type="text" class="form-control"  name="state" v-model="state">
                            <span v-show="errors.has('state') && online_event <= 0" class="help text-danger">{{ errors.first('state') }}</span>
                        </div>     
                        
                        <div class="form-group">
                            <label for="zipcode">{{ trans('em.zipcode') }}</label>
                            <input type="text" class="form-control"  name="zipcode" v-model="zipcode">
                            <span v-show="errors.has('zipcode') && online_event <= 0" class="help text-danger">{{ errors.first('zipcode') }}</span>
                        </div>     
                        ...
                        <div class="form-group">
                            ...
                            <span v-show="errors.has('country_id') && online_event <= 0" class="help text-danger">{{ errors.first('country_id') }}</span>
                        </div>     
