                    ...
                    <form ref="form" @submit.prevent="validateForm" method="POST" enctype="multipart/form-data"  class="lgx-contactform">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" v-model="repetitive" value = "1"  name="repetitive"> {{ trans('em.add_repetitive_schedules') }}
                                    </label>
                                </div>
                            </div>
...
export default {
    ...
    computed: {
        ...
        ...mapState( ['event_id', 'v_repetitive', 'v_repetitive_days', 'v_repetitive_dates', 'v_from_time', 'v_to_time', 'organiser_id', 'event']),
    },
