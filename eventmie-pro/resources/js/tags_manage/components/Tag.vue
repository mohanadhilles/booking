<template>
    <div class="row">
        <div class="col-md-12">
            ...
            <button type="button" class="lgx-btn lgx-btn-red lgx-btn-sm" @click="openModal = true" v-if="!edit_tag"><i class="fa fa-user-tag"></i> {{ trans('em.add_tag') }}</button>
