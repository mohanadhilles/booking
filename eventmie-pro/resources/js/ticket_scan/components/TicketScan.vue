<template>
    <div>
        <div class="table-responsive" v-if="Object.keys(booking).length > 0">
            ...
            <table class="table table-striped table-hover">
                ...
                <td>
                    <p class="text-bold text-small">{{ moment(convert_date_to_local(booking.event_start_date)).format('MMM DD,YY')+' - '+moment(convert_date_to_local(booking.event_end_date)).format('MMM DD,YY') }}</p>
                    <p class="text-bold text-small">{{ convert_time_to_local(booking.event_start_date, booking.event_start_time, 'hh:mm A')+' - '+convert_time_to_local(booking.event_end_date, booking.event_end_time, 'hh:mm A') }}</p>
                </td>
                </tr>
