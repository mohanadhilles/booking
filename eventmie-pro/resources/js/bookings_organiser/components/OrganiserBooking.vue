                ...
                <table class="table table-hover table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="col-xs-2">{{ trans('em.actions') }}</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="(booking, index) in bookings" :key="index" >
                            ...
                            <td>
                                ...
                                <div v-if="booking.online_location != null"> 
                                    <button type="button" class="lgx-btn lgx-btn-sm" @click="booking_id = booking.id">{{ trans('em.online_event')}}</button>
