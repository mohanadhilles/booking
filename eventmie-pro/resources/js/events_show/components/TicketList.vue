                    ...
                    <form ref="form" @submit.prevent="validateForm" method="POST" >
                                    ...
                                    <li class="list-group-item d-flex justify-content-between lh-condensed d-flex-wrap">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <p v-else>
                                                    <small class="text-muted">{{ changeTimeFormat(start_time,'hh:mm A') }} - {{ changeTimeFormat(end_time,'hh:mm A') }}</small>
                                                </p> -->
                                            </div>
                                        </div>
                                        ...
                                        <div class="w-10 w-20-mobile">
                                            ...
                                            <div v-if='typeof(booked_tickets[item.id+"-"+booked_date_server]) != "undefined"'>
                                                ...
                                                >
                                                    ...
                                                    <option :key="ind" v-if="booked_tickets[item.id+'-'+booked_date_server].total_vacant < max_ticket_qty"
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-xs-12" v-else>
                                <button type="button" class="btn lgx-btn btn-block" @click="loginFirst()"><i class="fas fa-fingerprint"></i> {{ trans('em.login') }}</button>
                            </div>
