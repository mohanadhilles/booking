...
class DataRowsTableSeeder extends Seeder
{
    ...
    protected function users()
    {
        ...
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "relationship", "display_name" => "Role", "required" => 0, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 0, "details" => [
        ...
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Role", "required" => 0, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "validation" => [
                "rule" => "required" 
            ] 
        ], "order" => 9, ])->save();
